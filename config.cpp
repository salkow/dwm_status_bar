...
// Update interval, signal, has event handler, needs internet
	...
	items_.push_back(new News			 (10, 1, 0, 0));
	// items_.push_back(new Updates		 (10, 2, 0, 0));
	items_.push_back(new Temp			 (60, 3, 0, 0));
	items_.push_back(new KeyboardLanguage(60, 4, 1, 0));
	items_.push_back(new Weather		 (60, 5, 0, 0));
	items_.push_back(new Volume			 (60, 6, 0, 0));
